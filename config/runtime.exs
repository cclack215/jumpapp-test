...
config :social_scribe, :hubspot_client_id, System.get_env("HUBSPOT_CLIENT_ID")
config :social_scribe, :hubspot_client_secret, System.get_env("HUBSPOT_CLIENT_SECRET")
config :social_scribe, :hubspot_redirect_uri, System.get_env("HUBSPOT_REDIRECT_URI")
...
if config_env() == :prod do
  ...
  config :social_scribe, :hubspot_redirect_uri, "https://" <> host <> "/auth/hubspot/callback"
